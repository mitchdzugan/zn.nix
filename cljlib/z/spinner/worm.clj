...
(defn styled
  ...
  (let [vinit (get u/vec-by-block-sextant " ")
        ...
        color-in-dir ((if (or (nil? droplet) hit?) identity dir-opp) dir)
        ...
        paints (->>
                 ...
                 :res)
        chars
          (->> paints (map vpath-of) (reduce #(assoc-in %1 %2 true) basevs))]
  ...
  (let [works-every-time? (< (rand) 0.6)
        ...
        next-droplet (case droplet
                       ...
                       (if (and did-loop?
                         ...
                         :spawn
                         nil))
        next-initial-pos (cond (nil? initial-pos) pos
